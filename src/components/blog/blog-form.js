...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            content: "",
            featured_image: "",
            apiUrl: "https://cory.devcamp.space/portfolio/portfolio_blogs",
            apiAction: "post"
        };
    ...
    deleteImage(imageType) {
        axios
            ...
            .then(response => {
                ...
                console.log("response from BI delete");
            })
            .catch(error => {
            ...
            <form onSubmit={this.handleSubmit} className="blog-form-wrapper">
                ...
                <div className="image-uploaders">
                    {this.props.editMode && this.props.blog.featured_image_url ? (
                        ...
                        <DropzoneComponent className="drop"
                            ref={this.featuredImageRef}
                            config={this.componentConfig()}
                            djsConfig={this.djsConfig()}
                            eventHandlers={this.handleFeaturedImageDelete()}
                        >
                ...
                <button className="btn">SAVE BLOG</button>
